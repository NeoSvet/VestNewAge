...
//import ru.neosvet.otkroveniya.BuildConfig; tut
...
public class HtmlTextView extends TextView {
	...
	//private static final String TAG = HtmlTextView.class.getSimpleName(); tut
	...
	private void fixSpannedWithSpaces(SpannableStringBuilder builder, int widthMeasureSpec, int heightMeasureSpec) {
		//long startFix = System.currentTimeMillis(); tut
