...
public class PageWorker extends Worker {
    ...
    public PageWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            initClient();
            if (getInputData().getBoolean(Const.LIST, false)) {

            } else if (getInputData().getBoolean(Const.PAGE, true)) {
